...
<head>
    ...
    <title>Edit Profile | Headturner's Helmet</title>
</head>
...
<body>
    ...
    <div class="mt-40 mb-40 p-10" style="padding: 0 20%">
        ...
        <h1 class="text-white" style="font-size: 50px; font-weight: 600;">Edit Personal Information</h1>
            ...
            ?>
            <img class="mt-5" src="<?php echo $image ?>" style="width:150px; height:150px; border-radius: 100%; border:5px solid #99aab5;"><br>
            <span style="color: #99aab5;">Date registered  :</span> <?php echo $date_reg ?> <br>
            <button data-modal-target="edit_image" data-modal-toggle="edit_image" type="button" class="mt-3 block text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-indigo-600 dark:focus:ring-blue-800"> 
                Update profile
            </button>
        </center>
        ...
        <div class="row mt-5">
            <div class="col-md-4">
                <Label><span style="color: #99aab5;">Full Name : </span> <?php echo $fname?></Label>
            </div>
            <div class="col-md-4">
                <Label><span style="color: #99aab5;">Contact : </span> <?php echo $contact?></Label>
            </div>
            <div class="col-md-4">
                <Label><span style="color: #99aab5;">Address : </span> <?php echo $address?></Label>
            </div>
            <div class="col-md-6 mt-3">
                <button data-modal-target="edit_profile" data-modal-toggle="edit_profile" type="button" class="block text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-indigo-600 dark:focus:ring-blue-800"> 
                    Update Information
                </button>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <Label><span style="color: #99aab5;">Email : </span> <?php echo $email?></Label>
            </div>
            <!--(Update Email)-->
            <div class="col-sm-6 mt-3">
                <button data-modal-target="edit_email" data-modal-toggle="edit_email" type="button" class="block text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-indigo-600 dark:focus:ring-blue-800"> 
                    Update Email
                </button>
            </div>
            <!--(Change password)-->
            <div class="col-sm-6 mt-3">
                <button data-modal-target="change_pass" data-modal-toggle="change_pass" type="button" class="block text-white btn btn-danger rounded-lg text-sm px-5 py-2.5 text-center"> 
                    Change Password
                </button>
            </div>
        </div>
