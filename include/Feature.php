    ...
    <section class="bg-gray-200 pt-20 pb-8 lg:pt-[50px] lg:pb-[70px]">
        <div class="container">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                        <span class="inline-block px-5 py-2 mb-5 text-xl font-bold text-white">
                            <p class="relative inline-block px-4 py-2 font-bold group">
                                <span class="absolute inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-black group-hover:-translate-x-0 group-hover:-translate-y-0"></span>
                                <span class="absolute inset-0 w-full h-full bg-white border-2 border-black group-hover:bg-black"></span>
                                <span class="relative text-black group-hover:text-white">FEATURED PRODUCTS</span>
                            </p>
                        </span>
                    </div>
                </div>
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4 sm:w-1/4 min-[600px]:w-1/4 min-[375px]:w-2/4">
                    <div class="mb-12 wow fadeInUp group" data-wow-delay=".1s">
                        <img src="https://i.ibb.co/t3cBM64/product8-fourteen.png" alt="">
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4 sm:w-1/4 min-[600px]:w-1/4 min-[375px]:w-2/4">
                    <div class="mb-12 wow fadeInUp group" data-wow-delay=".15s">
                        ...
                        <img src="https://i.ibb.co/3cfpzSG/product2-classic.png" alt="">
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4 sm:w-1/4 min-[600px]:w-1/4 min-[375px]:w-2/4">
                    <div class="mb-12 wow fadeInUp group" data-wow-delay=".2s">
                        <img src="https://i.ibb.co/Zf240Jj/shark-racerpro-gp-martinator.png" alt="">
                        <h4 class="flex justify-center mb-3 text-xl font-extrabold text-gray-900">
                            SHARK
                        </h4>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4 sm:w-1/4 min-[600px]:w-1/4 min-[375px]:w-2/4">
                    <div class="mb-12 wow fadeInUp group" data-wow-delay=".25s">
                        <img src="https://i.ibb.co/8B8spny/agv-k5-s-multi-mplk-full-face-helmet-1.png" alt="">
                        <h4 class="flex justify-center mb-3 text-xl font-extrabold text-gray-900">
                            AGV
                        </h4>
                        <a href="shop.php?product=agv" class="flex justify-center relative inline-block px-4 py-2 font-medium group">
                            <span class="absolute inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-black group-hover:-translate-x-0 group-hover:-translate-y-0"></span>
                            <span class="absolute inset-0 w-full h-full bg-white border-2 border-black group-hover:bg-black"></span>
                            <span class="relative text-black group-hover:text-white">Shop Now</span>
                        </a>
