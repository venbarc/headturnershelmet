      ...
      <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          <ul class="pb-2 space-y-2">
            ...
            <li>
              <a href=""
                class="flex items-center p-2 pt-12 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                <svg
            ...
            <li>
              ...
              <ul id="dropdown-crud" class="space-y-2 py-2 {{ if not (eq .Params.group " crud") }}hidden {{ end }}">
                <li>
                  <a href="{{ " crud/products/" | relURL }}"
                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ if eq $page_slug "
                    products" }} bg-gray-100 dark:bg-gray-700 {{ end }}">Unpaid</a>
                </li>
                <li>
                  <a href="{{ " crud/users/" | relURL }}"
                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ if eq $page_slug "
                    users" }} bg-gray-100 dark:bg-gray-700 {{ end }}">To ship</a>
                </li>
                <li>
                  <a href="{{ " crud/users/" | relURL }}"
                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ if eq $page_slug "
                    users" }} bg-gray-100 dark:bg-gray-700 {{ end }}">Shipped</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="{{ " settings/" | relURL }}"
        ...
        <div
          ...
          <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
            <img class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0"
              src="https://i0.wp.com/www.starmometer.com/wp-content/uploads/2010/10/kokey-4.jpg?fit=720%2C480"
              alt="Jese picture">
            <div>
              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class=" py-4">
                      <span
                        class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">Complete</span>
                    </td>
                  </tr>
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  ...
                  <tr class="bg-white dark:bg-gray-800">
                    ...
                    <td class="py-4">
                      <span
                        class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">Cancelled</span>
                    </td>
                  </tr>
                </tbody>
              </table>
