    ...
    <div class="w-3/12 p-3 bg-white rounded shadow-lg">
        <div class="flex items-center p-2 mb-5 space-x-4">
            ...
            <?php
                ...
                {
                    echo '
                        <img src="assets/images/profile/default_profile.png" class="h-12 rounded-full">
                    ';
                }
                else{
                    echo '
                        <img src="'.$image.'" class="h-12 rounded-full">
                    ';
                }
            ?>
            <div>
                <h4 class="text-lg font-semibold tracking-wide text-gray-700 capitalize font-poppins"><?php echo $fname .' '. $lname?></h4>
                <span class="flex items-center space-x-1 text-sm tracking-wide">
                    ...
                    <span class="text-gray-600"><?php echo $email?></span>
                </span>
                <span class="text-gray-700 text-sm"><?php echo $address .' | '?></span> 
                <span class="text-gray-700 text-sm"><?php echo $contact ?></span>
            </div>
        </div>

        <ul class="space-y-2 text-sm">
            <li>
                <a href="profile.php?sidenav_link=profile_info" class="flex items-center p-2 space-x-3 font-medium text-gray-700 rounded-md hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
            ...
            <li class="pt-40">
                <span>Member since <?php echo $formattedDate ?></span>
            </li>
        </ul>
    </div>
                        ...
                        ?>
                            ...
                            <form method="post" enctype="multipart/form-data" class="mb-20">
                                ...
                                <?php
                                    ...
                                    {
                                        echo '
                                            <img src="assets/images/profile/default_profile.png" class="h-50 rounded-full">
                                        ';
                                    }
                                    else
                                    {
                                        echo '
                                            <img src="'.$image.'" class="h-50 rounded-full">
                                        ';
                                    }
                                ?>
                                <input type="file" name="upload_profile">
                                <!-- update btn  -->
                                <input type="submit" value="Upload Image" name="upload_profile">
                            </form>
                            ...
                            <form method="post">
                                ...
                                <!-- submit button  -->
                                <input type="submit" value="Update Personal information" name="update_personal" class="btn bg-black">
                            </form>
                        <?php
                    }
                }
