      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <div
            ...
            if (isset($_POST['submit_pin']) && isset($_GET['email'])) 
            {
              $pin = $_POST['pin'];
              $email = $_GET['email'];
              ...
              if ($res_select->num_rows > 0) 
              {
                ...
                if ($pin == $pin_db) 
                {
                  ...
                  $stmt_update = $conn->prepare('update users set verification = 1 where email = ?');
            ...
            $stmt_select2 = $conn->prepare('select * from users where email = ? and verification = 0');
            $stmt_select2->execute([$email]);
            $res_select2 = $stmt_select2->get_result();

            if ($res_select2->num_rows > 0) 
            {
              ?>
